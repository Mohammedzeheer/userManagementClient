...
function AdminHome() {
    ...
    useEffect(()=>{
        axios.get(`http://localhost:4000/admin/adminhome`,{withCredentials:true}).then((res)=>{
          console.log(res ,"------------------------------------------");
                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        <button onClick={() => {
                                            ...
                                            className="edit-btn"><i class="fas fa-edit"></i></button>


                                        <button onClick={() => deleteUser(user._id)} class="delete-btn"><i class="fas fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            )
                        })
